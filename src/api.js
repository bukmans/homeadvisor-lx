...
<div class="header">
  <div>
    <h1>Immo<span class="gold">·LX</span></h1>
    <div style="font-family:sans-serif; font-size:12px; color:#718096;">Luxembourg Home Purchase Analysis &middot; Benefits &amp; Mortgage Simulation</div>
  </div>
...
<div class="footer">
  This report was produced by <strong>Immo·LX</strong>. It is provided for informational and simulation purposes only and does not constitute financial, legal, or mortgage advice. Benefit amounts and eligibility are based on Luxembourg government data (guichet.public.lu, logement.lu) as of September 2026. Interest rates are indicative, based on Banque Centrale du Luxembourg (BCL) data.<br><br>
  ...
  Consult a licensed mortgage broker or notary for personalised advice.
</div>
