      ...
      <div className="card">
        ...
        <div className="report-preview">
          <div className="report-header">
            <div>
              <div className="report-title">HomeAdvisor <span style={{ color: 'var(--gold)' }}>LX</span></div>
              <div className="report-sub">Luxembourg Home Purchase Analysis · AI-Powered by Claude</div>
            </div>
          ...
          {narrative && (
            <div className="report-section">
              <div className="report-label">AI Advisory Notes — Claude</div>
          ...
          <div style={{ marginTop: '14px', fontSize: '10px', color: 'var(--text-light)', fontFamily: 'var(--font-sans)', borderTop: '1px solid var(--border)', paddingTop: '10px' }}>
            Generated by HomeAdvisor LX · AI-Powered · For information purposes only · Verify with Guichet Unique des Aides au Logement, 11 rue de Hollerich, L-1741 Luxembourg
          </div>
        </div>
      </div>
      ...
      <div className="grid2">
        ...
        <div className="card">
          ...
          <div style={{ marginTop: '12px', fontSize: '10px', color: 'var(--text-light)', lineHeight: '1.6' }}>
            ℹ To enable live email: sign up at <strong>emailjs.com</strong> (free tier), create a template with the variables from <code>src/api.js</code>, and add the 3 credential keys to your <code>.env</code> file.
          </div>
        </div>
      </div>
