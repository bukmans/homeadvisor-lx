...
export const BELLEGEN_AKT_PER_PERSON     = 50000   // € per individual purchaser (raised 2024)
...
export const STATE_GUARANTEE_MAX         = 320000  // € (2026 index)
export const STATE_GUARANTEE_MAX_RATIO   = 0.40    // 40% of project cost
export const INCOME_LIMIT_SINGLE         = 107000  // € annual net (2026 index)
export const INCOME_LIMIT_COUPLE         = 148000  // € annual net (2026 index)
...
// ─── MORTGAGE MARKET RATES (September 2026 — BCL data) ──────────────────────
export const RATES = {
  fixed:      3.45,  // 25-year fixed
  variable:   2.75,  // ECB-linked variable
  adjustable: 3.10,  // 5-year adjustable / revisable
}
